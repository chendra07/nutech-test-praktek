...
class BannerSeeder extends typeorm_seeding_1.Seeder {
    constructor() {
        super(...arguments);
        this.name = "banner";
        this.date = 1726937588;
    }
    async run(dataSource) {
        ...
        try {
            ...
            const placeholders = extractedCsv
                ...
                values.push(banner.id, banner.banner_name, banner.description, banner.file_id);
                return `
