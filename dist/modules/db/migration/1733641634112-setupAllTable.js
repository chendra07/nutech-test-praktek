...
exports.SetupAllTable1733641634112 = void 0;
class SetupAllTable1733641634112 {
    constructor() {
        this.name = "SetupAllTable1733641634112";
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "banner" (
        "id" uuid NOT NULL, 
...
`);
        await queryRunner.query(`CREATE TABLE "ppob_service" (
...
`);
    ...
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_USER_FILE_FILEID"`);
        await queryRunner.query(`ALTER TABLE "ppob_service" DROP CONSTRAINT "FK_PPOBSERV_FILE_FILEID"`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_TRX_PPOBSERV_SERVCODE"`);
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_TRX_USER_USERID"`);
        await queryRunner.query(`ALTER TABLE "banner" DROP CONSTRAINT "FK_BANNER_FILE_FILEID"`);
...
exports.SetupAllTable1733641634112 = SetupAllTable1733641634112;
